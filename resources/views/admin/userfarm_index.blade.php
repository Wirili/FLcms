                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            var str='';
                            if(row.is_settle)
                                str = "<a href='javascript:js_confirm(\"确认要结算该会员的乐园宠物产币数据吗？\",\"/admin/userfarm/settle/" + row.user_id + "\")' data-toggle='tooltip' data-placement='bottom' title='@lang('sys.settle')' style='padding:0 5px;'><i class='fa fa-edit'></i></a>";
                            str += "<a href='javascript:js_confirm(\"确认要删除会员宠物？\",\"/admin/userfarm/del/" + row.id + "\")' class='text-danger' data-toggle='tooltip' data-placement='bottom' title='@lang('sys.del')' style='padding:0 5px;'><i class='fa fa-remove'></i></a>";
                            return str;
                        }
                    }
                ],

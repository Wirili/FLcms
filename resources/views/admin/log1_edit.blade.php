            ...
            <div class="tab-content" style="margin-top: 8px;">
                <div role="tabpanel" class="tab-pane active" id="home">
                    <div class="form-group">
                        ...
                        <div class="col-md-4"><input type="text" class="form-control input-sm" name="name" id="name"  value="{{$log1->name}}"></div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="parent_name">@lang('user.parent_name')</label>
                        <div class="col-md-4"><input class="form-control input-sm" name="parent_name" id="parent_name" value="{{$log1->parent_name}}"></div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="is_pass" id="is_pass">
                                ...
                                <option value="{{$k}}" @if($log1->is_pass==$k) selected @endif>{{$v}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4"><p class="form-control-static">{{$log1->point1}}</p></div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label">@lang('user.point2')</label>
                        <div class="col-md-4"><p class="form-control-static">{{$log1->point2}}</p></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4"><p class="form-control-static">{{$log1->reg_time}}</p></div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label" >@lang('user.reg_ip')</label>
                        <div class="col-md-4"><p class="form-control-static">{{$log1->reg_ip}}</p></div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label" >@lang('user.login_count')</label>
                        <div class="col-md-4"><p class="form-control-static">{{$log1->login_count}}</p></div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label" >@lang('user.last_time')</label>
                        <div class="col-md-4"><p class="form-control-static">{{$log1->last_time}}</p></div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-2 control-label" >@lang('user.last_ip')</label>
                        <div class="col-md-4"><p class="form-control-static">{{$log1->last_ip}}</p></div>
                    </div>
                </div>
            </div>
            <div class="text-center" style="padding: 10px 0; border-top: 1px solid #f4f4f4;">
                <input type="hidden" name="id" value="{{$log1->user_id}}">
